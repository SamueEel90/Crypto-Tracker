...
import { useFetchTopVolume } from "../features/CoinGecko";
import { useEffect } from "react";

const TopVolumeDisplay = () => {
  const { refetch, data } = useFetchTopVolume();
    ...
    <div className="mt-10 mb-10 min-w-[250px] w-[400px]">
      <div className="border-1 border-gray-600 rounded-xl p-4 bg-dark-gray">
        <div className="grid grid-cols-2 border-b-1 border-gray-600 pb-2">
          <p className="text-amber-50">Top Volume</p>
          <span className="text-right text-amber-50 cursor-pointer hover:underline">
            More &rarr;
          </span>
        </div>
...
export default TopVolumeDisplay;
